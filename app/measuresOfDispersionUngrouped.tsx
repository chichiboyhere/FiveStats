...
const MeasuresOfDispersionUngrouped = () => {
  ...
  const calculateMean = () => {
    if (data.some((row) => row.value === "" || row.frequency === "")) {
    ...
    try {
      ...
      if (err instanceof Error) setInvalidInput(err.message);
    }
  };
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.header}>
        ...
        (Ungrouped)Calculator
      </Text>
      <Text style={styles.additionalHeaderText}>
        You may adjust the frequency field as required
      </Text>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity onPress={calculateMean} style={styles.calcButton}>
